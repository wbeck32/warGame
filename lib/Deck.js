...
function () {
  ...
  (0, _createClass2.default)(Deck, [{
    ...
    value: function deal() {
      ...
      var numHands = numRanks; // let numPersons = numPlayers;
    ...
    value: function createDeck() {
      ...
      if (numRanks > 13 || numSuits > 4) {
        console.log("Nope, that would make ".concat(numRanks * numSuits, " cards and that is too many cards."));
        return;
      }
      ...
      if (even > 1) {
        console.log("That is not a fair game. One player would only have ".concat(even, " cards."));
        return;
      }
