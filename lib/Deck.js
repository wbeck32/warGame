...
function () {
  ...
  _createClass(Deck, [{
    ...
    value: function deal() {
      ...
      Each array would have a structure like this:
      [
      [
      ...
      var dealtArray = [];
      var handArray = Array.from({
        length: numRanks
      }, function (x, i) {
        return [];
      });
      dealStack.forEach(function (card, idx) {
        handArray.forEach(function (hand, i) {
      ...
      dealtArray.forEach(function (ele) {
        var handId = 0;
